      ...
      <div className="portfolio-container">
        ...
        <section id="contact" className="reveal contact-section">
          ...
          <div className="contact-actions">
            ...
            <a href="https://www.linkedin.com/in/subhajyoti-maity-581898288" target="_blank" rel="noopener noreferrer" className="cta">Connect on LinkedIn</a>
          </div>
        </section>
        ...
        <footer className="footer reveal">
          <div className="social-icons-footer">
            ...
            <a href="https://www.linkedin.com/in/subhajyoti-maity-581898288" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
